 ...
 * *********************************************************************/
function InitCufon () {
 	Cufon.replace('.logo .title', { fontFamily: 'UTM Gill Sans KT', color: '-linear-gradient(#FFFFFF, #FFFFFF, #c0c0c0, rgb(200, 200, 200))', textShadow: '#FFFFFF 0px 1px'});
	Cufon.replace('.user-detail .name', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('.visualize-title', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('table caption', { fontFamily: 'UTM Gill Sans KT' });

	Cufon.replace('h1', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h2', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h3', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h4', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h5', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h6', { fontFamily: 'UTM Gill Sans KT' });
	Cufon.replace('h1 .label', { fontFamily: 'UTM Gill Sans KT' });
}
